...
<body>
	...
	그냥 출력 : ${num1} <br>
	세자리마다 구분하여 출력 : <fmt:formatNumber value="${num1}" groupingUsed="true"/> <br> <!-- groupingUsed 기본값은 true(,로 구분을 해준다는 뜻) -->
	숫자 그대로 출력 : ${num1} <br><br>
	...
	<ul>
		<li>현재 날짜 : <fmt:formatDate value="${current}" /></li> <!-- type생략시 type="date"가 디폴트 -->
		...
		<li>사용자지정 : <fmt:formatDate value="${current}" type="both" dateStyle="short" pattern="yyyy-MM-dd(E) (a)HH:mm:ss" /></li> 
	</ul>
